...
```mermaid
flowchart TD
    A["Chapter 1: The Window Sill Gift<br/>(Kura receives Vulpes Zerda / names Zerdata)"] --> B["Chapter 2: Local Battles & Bully Defiance<br/>(Earning Scrap, helping Mom, upgrading Zerdata)"]
    B --> C["Chapter 3: Encounter with Anode Group<br/>(Magnus's syndicate threatens the city & scrap trade)"]
    C --> D["Chapter 4: The Truth of the Father<br/>(Uncovering the 4-year-old mystery & Ancient Trio link)"]
    D --> E["Chapter 5: AniBot World Cup Finals<br/>(Kura vs Luk in the ultimate showdown)"]
```
